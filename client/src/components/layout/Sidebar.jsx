      ...
      >
        <div className="px-5 h-16 flex items-center border-b border-slate-100 dark:border-slate-800/60">
          ...
          >
            ...
            <span className="text-base font-bold tracking-tight dark:text-white">HireFlow</span>
          </button>
        </div>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <Icon
                    size={17}
                    className={cn(isActive ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500 dark:text-slate-400')}
                  />
